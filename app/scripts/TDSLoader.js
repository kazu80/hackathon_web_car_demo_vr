                ...
                if (next === POINT_ARRAY) {
                    ...
                    if (useBufferGeometry) {
                        ...
                        for (var i = 0; i < points; i++) {
                            ...
                            geometry.vertices.push (new THREE.Vector3 (this.readFloat (data), this.readFloat (data),
                                                                       this.readFloat (data)));
        ...
        readFaceArray: function (data, mesh) {
            ...
            for (var i = 0; i < faces; ++i) {
                ...
                mesh.geometry.faces.push (
                    new THREE.Face3 (this.readWord (data), this.readWord (data), this.readWord (data)));
