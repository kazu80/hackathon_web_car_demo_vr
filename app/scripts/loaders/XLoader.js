    ...
    var XLoader = function () {
        ...
        createClass (XLoader, [{
                ...
                while (true) {
                    ...
                    if (find1 > 0 && findEnd > find1) {
                        ...
                        if (_currentObject.type === 'Animation') {
                            ...
                            var DataEnder = this._data.lastIndexOf (';', findNext > 0 ? Math.min (findNext,
                                                                                                  findEnd) : findEnd);
                            ...
                            case 'MeshNormals':
                                switch (mode) {
                                    ...
                                    case 0:
                                        ...
                                        break;
                                    case 1:
                                        this._readNormalFace1 (
                                            this._currentObject.data.substr (endRead, find - endRead), nowReadedLine);
                                        break;
            ...
            value: function _readVertex1 (line) {
                ...
                this._currentGeo.Geometry.vertices.push (
            ...
            value: function _readFace1 (line) {
                ...
                this._currentGeo.Geometry.faces.push (
                    new THREE.Face3 (parseInt (data[0], 10), parseInt (data[1], 10), parseInt (data[2], 10),
            ...
            value: function _readNormalVector1 (line) {
                ...
                var data = this._readLine (line.trim ()).substr (0, line.length - 2).split (';');
                this._currentGeo.normalVectors.push (
                    new THREE.Vector3 (parseFloat (data[0]), parseFloat (data[1]), parseFloat (data[2])));
                    ...
                    switch (mode) {
                        ...
                        case 0:
                            if (mode_local === 0) {
                                ...
                                this._currentGeo.normalVectors.push (
                                    [parseFloat (data[0]), parseFloat (data[1]), parseFloat (data[2])]);
                                endRead = find + 1;
            ...
            value: function _setMeshTextureCoords () {
                        ...
                        case 0:
                            if (mode_local === 0) {
                                ...
                                if (this.IsUvYReverse) {
                                    ...
                                    this._tmpUvArray.push (
                                        new THREE.Vector2 (parseFloat (data[0]), 1 - parseFloat (data[1])));

                                } else {

                                    this._tmpUvArray.push (
                                        new THREE.Vector2 (parseFloat (data[0]), parseFloat (data[1])));
                ...
                for (var m = 0; m < this._currentGeo.Geometry.faces.length; m++) {
                    ...
                    this._currentGeo.Geometry.faceVertexUvs[0][m].push (
                        this._tmpUvArray[this._currentGeo.Geometry.faces[m].a]);
                    this._currentGeo.Geometry.faceVertexUvs[0][m].push (
                        this._tmpUvArray[this._currentGeo.Geometry.faces[m].b]);
                    this._currentGeo.Geometry.faceVertexUvs[0][m].push (
                        this._tmpUvArray[this._currentGeo.Geometry.faces[m].c]);
            ...
            value: function _makeOutputGeometry () {
                ...
                if (this._currentGeo.BoneInfs.length > 0) {
                    ...
                    mesh = new THREE.Mesh (_bufferGeometry,
                                           this._currentGeo.Materials.length === 1 ? this._currentGeo.Materials[0] : this._currentGeo.Materials);
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    if (nowKeyType != 4) {
                        ...
                        switch (nowKeyType) {
                            ...
                            case 0:
                                keyInfo.rot = new THREE.Quaternion (parseFloat (frameValue[1]),
                                                                    parseFloat (frameValue[2]),
                                                                    parseFloat (frameValue[3]), parseFloat (
                                    frameValue[0]) * -1);
                                break;
                            case 1:
            ...
            value: function _ParseMatrixData (targetMatrix, data) {
                ...
                targetMatrix.set (parseFloat (data[0]), parseFloat (data[4]), parseFloat (data[8]),
                                  parseFloat (data[12]), parseFloat (data[1]), parseFloat (data[5]),
                                  parseFloat (data[9]), parseFloat (data[13]), parseFloat (data[2]),
                                  parseFloat (data[6]), parseFloat (data[10]), parseFloat (data[14]),
                                  parseFloat (data[3]), parseFloat (data[7]), parseFloat (data[11]),
                                  parseFloat (data[15]));
