(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        define ('three.MMDLoader', ['three'], factory);
    }
 ...
 */
    ...
    THREE.MMDLoader.prototype.loadVpd = function (url, callback, onProgress, onError, params) {
        ...
        var func = ((params && params.charcode === 'unicode') ? this.loadFileAsText : this.loadFileAsShiftJISText).bind (
            this);
                ...
                if (p.map !== undefined) {
                    ...
                    function checkTextureTransparency (m) {
						 ...
						 */
                            ...
                            if (detectTextureTransparency (imageData, geometry.attributes.uv.array,
                                                           indices)) {
                                m.transparent = true;
                            }
    ...
    THREE.MMDLoader.prototype.createAnimation = function (mesh, vmd, name) {
        ...
        var initMotionAnimations = function () {
            ...
            for (var i = 0; i < orderedMotions.length; i++) {
                ...
                tracks.push (new THREE.MMDLoader.VectorKeyframeTrackEx (boneName + '.position', times, positions,
                                                                                                pInterpolations));
                tracks.push (new THREE.MMDLoader.QuaternionKeyframeTrackEx (boneName + '.quaternion', times, rotations,
                                                                                                      rInterpolations));
        ...
        var initMorphAnimations = function () {
            ...
            var clip = new THREE.AnimationClip (name === undefined ? THREE.Math.generateUUID () : name + 'Morph', -1,
                                                tracks);
 ...
 */
    ...
    THREE.MMDLoader.VectorKeyframeTrackEx.prototype.InterpolantFactoryMethodCubicBezier = function (result) {
        ...
        return new THREE.MMDLoader.CubicBezierInterpolation (this.times, this.values, this.getValueSize (), result,
    ...
    THREE.MMDLoader.CubicBezierInterpolation = function (parameterPositions, sampleValues, sampleSize, resultBuffer,
        params) {
