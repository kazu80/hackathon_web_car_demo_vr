        ...
        parse: function (buffer, path) {
            ...
            Virtulous.KeyFrame = function (time, matrix) {
                ...
                this.lerp = function (nextKey, time) {
                    ...
                    return Virtulous.KeyFrame.tempAniMatrix.compose (Virtulous.KeyFrame.tempAniPos,
                ...
                this.toTHREE = function (scene) {
                    ...
                    if (this.mTexCoordsBuffers[0] && this.mTexCoordsBuffers[0].length > 0) {
                        geometry.addAttribute ('uv',
                                               new THREE.BufferAttribute (new Float32Array (this.mTexCoordsBuffers[0]),
                                                                          2));
                    }
                    if (this.mTexCoordsBuffers[1] && this.mTexCoordsBuffers[1].length > 0) {
                        geometry.addAttribute ('uv1',
                                               new THREE.BufferAttribute (new Float32Array (this.mTexCoordsBuffers[1]),
                                                                          2));
                    }
                ...
                if (c & ASSBIN_MESH_HAS_POSITIONS) {
                    ...
                    if (shortened) {
                        ...
                        mesh.mVertexBuffer = stream.subArray32 (
                            stream.readOffset, stream.readOffset + mesh.mNumVertices * 3 * 4);
                ...
                for (var n = 0; n < AI_MAX_NUMBER_OF_COLOR_SETS; ++n) {
                    ...
                    if (shortened) {
                        ...
                        mesh.mColorBuffer = stream.subArray32 (
                            stream.readOffset, stream.readOffset + mesh.mNumVertices * 4 * 4);
