(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        define ('three.VTKLoader', ['three'], factory);
    }
            ...
            function parseXML (stringFile) {
                ...
                function Base64toByteArray (b64) {
                    ...
                    for (i = 0, j = 0; i < l; i += 4, j += 3) {
                        ...
                        tmp = (revLookup[b64.charCodeAt (
                            i)] << 18) | (revLookup[b64.charCodeAt (i + 1)] << 12) | (revLookup[b64.charCodeAt (i + 2)] << 6) | revLookup[b64.charCodeAt (i + 3)];
                    ...
                    if (placeHolders === 2) {
                        ...
                        tmp = (revLookup[b64.charCodeAt (
                            i)] << 10) | (revLookup[b64.charCodeAt (i + 1)] << 4) | (revLookup[b64.charCodeAt (i + 2)] >> 2);
                        arr[L++] = (tmp >> 8) & 0xFF;
                        arr[L++] = tmp & 0xFF;
                ...
                function parseDataArray (ele, compressed) {
                    ...
                    if (ele.attributes.format === 'binary' && compressed) {
                        ...
                        var rawData, content, byteData, blocks, cSizeStart, headerSize, padding, dataOffsets,
                            currentOffset;
                        ...
                        for (var i = 0; i < dataOffsets.length - 1; i++) {
                            ...
                            var inflate = new Zlib.Inflate (byteData.slice (dataOffsets[i], dataOffsets[i + 1]),
                                                            {resize: true, verify: true}); // eslint-disable-line no-undef
