(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        define ('three.ColladaLoader', ['three'], factory);
    }
        ...
        parse: function (text, path) {
            ...
            function buildAnimationChannel (channel, inputSource, outputSource) {
                ...
                switch (transform) {
                    ...
                    case 'translate':
                        console.warn ('THREE.ColladaLoader: Animation transform type "%s" not yet implemented.',
                                      transform);
                        break;
            ...
            function createKeyframeTracks (animation, tracks) {
                ...
                if (quaternionData.length > 0) {
                    tracks.push (
                        new THREE.QuaternionKeyframeTrack (name + '.quaternion', times, quaternionData));
                }
            ...
            function buildSkin (data) {
                ...
                for (i = 0, l = jointSource.array.length; i < l; i++) {
                    ...
                    var boneInverse = new THREE.Matrix4 ().fromArray (
                        inverseSource.array, i * inverseSource.stride).transpose ();
            ...
            function buildMaterial (data) {
                ...
                function getTexture (textureObject) {
                    ...
                    if (sampler !== undefined) {
                        ...
                        if (extra !== undefined && extra.technique !== undefined && isEmpty (
                                extra.technique) === false) {
            ...
            function buildGeometryType (primitives, sources, vertices) {
                                    ...
                                    switch (key) {
                                        ...
                                        case 'POSITION':
                                            ...
                                            if (sources.skinWeights && sources.skinIndices) {
                                                ...
                                                buildGeometryData (primitive, sources.skinIndices, input.offset,
                                                                   skinIndex.array);
                                                buildGeometryData (primitive, sources.skinWeights, input.offset,
                                                                   skinWeight.array);
                ...
                if (position.array.length > 0) {
                    geometry.addAttribute ('position',
                                           new THREE.Float32BufferAttribute (position.array,
                                                                             position.stride));
                }
                if (normal.array.length > 0) {
                    geometry.addAttribute ('normal',
                                           new THREE.Float32BufferAttribute (normal.array,
                                                                             normal.stride));
                }
                if (color.array.length > 0) {
                    geometry.addAttribute ('color',
                                           new THREE.Float32BufferAttribute (color.array,
                                                                             color.stride));
                }
                ...
                if (skinIndex.array.length > 0) {
                    geometry.addAttribute ('skinIndex', new THREE.Float32BufferAttribute (
                        skinIndex.array, skinIndex.stride));
                }
                if (skinWeight.array.length > 0) {
                    geometry.addAttribute ('skinWeight', new THREE.Float32BufferAttribute (
                        skinWeight.array, skinWeight.stride));
                }
                                ...
                                for (var i = 0; i < transforms.length; i++) {
                                    ...
                                    if (transform.sid && transform.sid.indexOf (jointIndex) !== -1) {
                                        ...
                                        switch (transform.type) {
                                            ...
                                            case 'translate':
                                                matrix.multiply (m0.makeTranslation (transform.obj.x, transform.obj.y,
                                                                                     transform.obj.z));
                                                break;
