    ...
    THREE.LoaderSupport.Builder = (function () {
        ...
        Builder.prototype.setMaterials = function (materials) {
            var payload = {
                ...
                materials: {
                    ...
                    runtimeMaterials         : Validator.isValid (
                        this.callbacks.onLoadMaterials) ? this.callbacks.onLoadMaterials (materials) : materials
                }
            };
        ...
        Builder.prototype._setCallbacks = function (callbacks) {
            ...
            if (Validator.isValid (callbacks.onMeshAlter)) {
                this.callbacks.setCallbackOnMeshAlter (
            ...
            if (Validator.isValid (callbacks.onLoadMaterials)) {
                this.callbacks.setCallbackOnLoadMaterials (
        ...
        Builder.prototype.buildMeshes = function (meshPayload) {
            ...
            bufferGeometry.addAttribute ('position',
                                         new THREE.BufferAttribute (new Float32Array (meshPayload.buffers.vertices),
                                                                    3));
            ...
            if (haveVertexColors) {
                ...
                bufferGeometry.addAttribute ('color',
                                             new THREE.BufferAttribute (new Float32Array (meshPayload.buffers.colors),
                                                                        3));
            ...
            if (Validator.isValid (meshPayload.buffers.normals)) {
                ...
                bufferGeometry.addAttribute ('normal',
                                             new THREE.BufferAttribute (new Float32Array (meshPayload.buffers.normals),
                                                                        3));
        ...
        Builder.prototype.updateMaterials = function (materialPayload) {
            ...
            if (Validator.isValid (materialCloneInstructions)) {
                ...
                for (var key in materialProperties) {
                    ...
                    if (material.hasOwnProperty (key) && materialProperties.hasOwnProperty (
                            key)) {
    ...
    THREE.LoaderSupport.WorkerSupport = (function () {
        ...
        var LoaderWorker = (function () {
            ...
            LoaderWorker.prototype.setTerminateRequested = function (terminateRequested) {
                ...
                if (this.terminateRequested && Validator.isValid (this.worker) && !Validator.isValid (
                        this.queuedMessage) && this.started) {
        ...
        WorkerSupport.prototype.validate = function (functionCodeBuilder, libLocations, libPath, runnerImpl) {
            if (Validator.isValid (this.loaderWorker.worker)) {
                return;
            }
            ...
            if (Validator.isValid (runnerImpl)) {
                ...
                this.logger.logInfo (
                    'WorkerSupport: Using DEFAULT "THREE.LoaderSupport.WorkerRunnerRefImpl" as Runncer class for worker.');
