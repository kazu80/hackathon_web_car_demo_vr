(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        define ('three.GLTFLoader', ['three'], factory);
    }
    ...
    THREE.GLTFLoader = (function () {
        ...
        GLTFMaterialsCommonExtension.prototype.extendParams = function (materialParams, material, parser) {
            ...
            if (materialValues.specularTexture !== undefined) {
                ...
                pending.push (
                    parser.assignTexture (materialParams, 'specularMap', materialValues.specularTexture.index));
                    ...
                    if (uvScaleMap !== undefined) {
                        ...
                        if (uvScaleMap.matrix !== undefined) {
                            ...
                            if (uvScaleMap.matrixAutoUpdate === true) {
                                ...
                                uvScaleMap.matrix.setUvTransform (offset.x, offset.y, repeat.x, repeat.y, rotation,
                                                                  center.x, center.y);
        ...
        GLTFParser.prototype.loadAccessor = function (accessorIndex) {
            ...
            return Promise.all (pendingBufferViews).then (function (bufferViews) {
                ...
                if (byteStride && byteStride !== itemBytes) {
                    ...
                    bufferAttribute = new THREE.InterleavedBufferAttribute (ib,
                                                                            itemSize, accessorDef.byteOffset / elementBytes,
                                                                            normalized);
                ...
                if (accessorDef.sparse !== undefined) {
                    ...
                    var sparseIndices = new TypedArrayIndices (bufferViews[1],
        ...
        GLTFParser.prototype.loadCamera = function (cameraIndex) {
            ...
            if (cameraDef.type === 'perspective') {
                ...
                camera = new THREE.PerspectiveCamera (THREE.Math.radToDeg (xfov),
                                                      aspectRatio, params.znear || 1, params.zfar || 2e6);

            } else if (cameraDef.type === 'orthographic') {

                camera = new THREE.OrthographicCamera (params.xmag / -2, params.xmag / 2, params.ymag / 2, params.ymag / -2,
                        ...
                        if (node) {
                            ...
                            if (sampler.interpolation === 'CUBICSPLINE') {
                                ...
                                for (var j = 0, jl = outputAccessor.count; j < jl; j += 3) {
                                    ...
                                    if (itemSize > 1) {
                                        outputAccessorValues[j * itemSize / 3 + 1] = outputAccessor.getY (j + 1);
                                    }
                                    if (itemSize > 2) {
                                        outputAccessorValues[j * itemSize / 3 + 2] = outputAccessor.getZ (j + 1);
                                    }
                                    if (itemSize > 3) {
                                        outputAccessorValues[j * itemSize / 3 + 3] = outputAccessor.getW (j + 1);
                                    }

                                }

                                outputAccessor = new THREE.BufferAttribute (outputAccessorValues, itemSize / 3,
