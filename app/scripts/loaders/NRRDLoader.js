(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        define ('three.NRRDLoader', ['three'], factory);
    }
        ...
        parse: function (data) {
            ...
            function parseHeader (header) {
                ...
                if (!headerObject.vectors) {
                    ...
                    headerObject.vectors = [new THREE.Vector3 (1, 0, 0), new THREE.Vector3 (0, 1, 0),
            ...
            volume.RASDimensions = (new THREE.Vector3 (volume.xLength, volume.yLength, volume.zLength)).applyMatrix4 (
                volume.matrix).round ().toArray ().map (Math.abs);
