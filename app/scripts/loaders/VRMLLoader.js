(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        define ('three.VRMLLoader', ['three'], factory);
    }
                        ...
                        switch (fieldName) {
                            ...
                            case 'size':
                                if (parts.length !== 4) {
                                    ...
                                    console.warn ('THREE.VRMLLoader: Invalid vector format detected for %s.',
                                                  fieldName);
                                    break;
                            ...
                            case 'rotation':
                                if (parts.length !== 5) {
                                    ...
                                    console.warn ('THREE.VRMLLoader: Invalid quaternion format detected for %s.',
                                                  fieldName);
                                    break;
                ...
                function parseNode (data, parent) {
                    ...
                    if (data.nodeType === 'AmbientLight') {
                        ...
                        if (data.groundColor !== undefined) {
                            ...
                            var groundGeometry = new THREE.SphereBufferGeometry (radius, segments, segments,
                                                                                 0, 2 * Math.PI, 0.5 * Math.PI, 1.5 * Math.PI);
                            var groundMaterial = new THREE.MeshBasicMaterial (
                                {fog: false, side: THREE.BackSide, vertexColors: THREE.VertexColors});
                        ...
                        if (data.nodeType === 'Box') {
                            ...
                            parent.geometry = new THREE.CylinderBufferGeometry (data.topRadius, data.bottomRadius,
                                                                                data.height);
