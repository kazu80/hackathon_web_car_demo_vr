(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        define ('three.SEA3DLoader', ['three'], factory);
    }
        ...
        play: function (name, crossfade, offset, weight) {
            ...
            if (animation == this.currentAnimation) {
                ...
                if (offset !== undefined || !animation.repeat) {
                    this.currentAnimationAction.time = offset !== undefined ? offset :
                ...
                this.currentAnimationAction = this.mixer.clipAction (animation.clip).setLoop (
                    animation.repeat ? THREE.LoopRepeat : THREE.LoopOnce, Infinity).reset ();
                ...
                if (this.previousAnimation) {
                    this.previousAnimationAction.crossFadeTo (
                        this.currentAnimationAction, crossfade || 0, false);
                }
    ...
    THREE.SEA3D.Object3DAnimator.prototype = Object.assign (Object.create (THREE.SEA3D.Animator.prototype), {
        ...
        setRelative: function (val) {
            ...
            this.updateAnimations (this.clips,
                                   new THREE.AnimationMixer (this.relative ? this.object3d.animate : this.object3d));
    ...
    THREE.SEA3D.SkinnedMesh.prototype = Object.assign (Object.create (THREE.SkinnedMesh.prototype),
                                                       THREE.SEA3D.Mesh.prototype, THREE.SEA3D.Animator.prototype, {
                                                           ...
                                                           copy: function (source) {
                                                               ...
                                                               if (source.animator) {
                                                                   this.animator = source.animator.clone (
                                                                       this);
                                                               }
    ...
    THREE.SEA3D.VertexAnimationMesh.prototype = Object.assign (Object.create (THREE.Mesh.prototype),
    ...
    THREE.SEA3D.Camera.prototype = Object.assign (Object.create (THREE.PerspectiveCamera.prototype),
    ...
    THREE.SEA3D.OrthographicCamera.prototype = Object.assign (Object.create (THREE.OrthographicCamera.prototype),
                                                              THREE.SEA3D.Object3D.prototype, {
                                                                  ...
                                                                  copy: function (source) {
                                                                      ...
                                                                      THREE.OrthographicCamera.prototype.copy.call (
                                                                          this, source);
    ...
    THREE.SEA3D.PointLight.prototype = Object.assign (Object.create (THREE.PointLight.prototype),
                                                      THREE.SEA3D.Object3D.prototype, {
    ...
    THREE.SEA3D.PointSound.prototype = Object.assign (Object.create (THREE.PositionalAudio.prototype),
                                                      THREE.SEA3D.Object3D.prototype, {
    ...
    THREE.SEA3D.prototype.readSkeletonAnimation = function (sea, skl) {
        ...
        for (var i = 0; i < sea.sequence.length; i++) {
            ...
            animations.push (
                THREE.SEA3D.AnimationClip.fromClip (THREE.AnimationClip.parseAnimation (animation, skl.tag),
                                                    seq.repeat));
    ...
    THREE.SEA3D.prototype.readVertexAnimation = function (sea) {
        ...
        for (i = 0; i < sea.sequence.length; i++) {
            ...
            animations.push (THREE.SEA3D.AnimationClip.fromClip (
                THREE.AnimationClip.CreateFromMorphTargetSequence (seq.name, seqTargets, sea.frameRate), seq.repeat));
