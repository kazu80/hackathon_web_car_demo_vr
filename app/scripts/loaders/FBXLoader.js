(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        define ('three.FBXLoader', ['three'], factory);
    }
    ...
    (function () {
            ...
            parse: function (FBXBuffer, resourceDirectory) {
                ...
                if (isFbxFormatBinary (FBXBuffer)) {
                    ...
                    if (getFbxVersion (FBXText) < 7000) {
                        ...
                        throw new Error ('THREE.FBXLoader: FBX version not supported, FileVersion: ' + getFbxVersion (
                            FBXText));
        ...
        function loadTexture (textureNode, loader, imageMap, connections) {
            ...
            else if (relativeFilePath !== undefined && relativeFilePath[0] !== '/' && relativeFilePath.match (
                    /^[a-zA-Z]:/) === null) {
        ...
        function parseMeshGeometry (FBXTree, relationships, geometryNode, skeletons) {
            ...
            if ('GeometricTranslation' in modelNode.properties) {
                ...
                preTransform.setPosition (
                    new THREE.Vector3 ().fromArray (modelNode.properties.GeometricTranslation.value));
        ...
        function getData (polygonVertexIndex, polygonIndex, vertexIndex, infoObject) {
            ...
            return GetData[infoObject.mappingType][infoObject.referenceType] (polygonVertexIndex, polygonIndex,
                                                                              vertexIndex, infoObject);
        ...
        function parseNurbsGeometry (geometryNode) {
            ...
            if (isNaN (order)) {
                ...
                console.error ('THREE.FBXLoader: Invalid Order %s given for geometry ID: %s',
        ...
        function parseAnimations (FBXTree, connections) {
            ...
            if (FBXTree.Objects.subNodes.AnimationCurve === undefined) {
                return undefined;
            }
                        ...
                        if (curveNodesMap.has (child.ID)) {
                            ...
                            if (layerCurveNodes[i] === undefined) {
                                ...
                                if ('Lcl_Translation' in rawModel.properties) {
                                    node.initialPosition = rawModel.properties.Lcl_Translation.value;
                                }

                                if ('Lcl_Rotation' in rawModel.properties) {
                                    node.initialRotation = rawModel.properties.Lcl_Rotation.value;
                                }

                                if ('Lcl_Scaling' in rawModel.properties) {
                                    node.initialScale = rawModel.properties.Lcl_Scaling.value;
                                }

                                // if the animated model is pre rotated, we'll have to apply the pre rotations to every
                                // animation value as well
                                if ('PreRotation' in rawModel.properties) {
                                    node.preRotations = rawModel.properties.PreRotation.value;
                                }
        ...
        function generateTracks (rawTracks) {
            ...
            if (rawTracks.T !== undefined) {
                ...
                var positionTrack = generateVectorTrack (rawTracks.modelName, rawTracks.T.curves,
                                                         rawTracks.initialPosition, 'position');
            ...
            if (rawTracks.R !== undefined) {
                ...
                var rotationTrack = generateRotationTrack (rawTracks.modelName, rawTracks.R.curves,
                                                           rawTracks.initialRotation, rawTracks.preRotations);
                ...
                while (endOffset > reader.getOffset ()) {
                    ...
                    if (name === 'Properties70' && node.name === 'P') {
                        ...
                        if (innerPropName.indexOf ('Lcl ') === 0) {
                            innerPropName = innerPropName.replace ('Lcl ',
                                                                   'Lcl_');
                        }
                        if (innerPropType1.indexOf ('Lcl ') === 0) {
                            innerPropType1 = innerPropType1.replace ('Lcl ',
                                                                     'Lcl_');
                        }

                        if (innerPropType1 === 'ColorRGB' || innerPropType1 === 'Vector' || innerPropType1 === 'Vector3D' || innerPropType1.indexOf (
                                'Lcl_') === 0) {
        ...
        function isFbxFormatBinary (buffer) {
            ...
            return buffer.byteLength >= CORRECT.length && CORRECT === convertArrayBufferToString (buffer, 0,
                                                                                                  CORRECT.length);
