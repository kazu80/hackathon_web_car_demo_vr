(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        define ('three.BVHLoader', ['three'], factory);
    }
            ...
            function toTHREEAnimation (bones) {
                ...
                for (var i = 0; i < bones.length; i++) {
                    ...
                    if (scope.animateBonePositions) {
                        ...
                        tracks.push (
                            new THREE.VectorKeyframeTrack ('.bones[' + bone.name + '].position', times, positions));

                    }

                    if (scope.animateBoneRotations) {

                        tracks.push (new THREE.QuaternionKeyframeTrack ('.bones[' + bone.name + '].quaternion', times,
                                                                                                                rotations));
